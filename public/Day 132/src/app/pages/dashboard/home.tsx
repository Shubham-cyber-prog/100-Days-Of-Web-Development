    ...
    <div className="space-y-6 max-w-7xl">
      ...
      >
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300">Here's what's happening with your AI assistant today.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          return (
            ...
            >
              <Card className="backdrop-blur-xl bg-white/80 dark:bg-card/80 border-white/40 dark:border-border rounded-3xl hover:shadow-xl transition-all duration-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="backdrop-blur-xl bg-white/80 dark:bg-card/80 border-white/40 dark:border-border rounded-3xl">
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              {tasks.map((task) => (
                <div
                  key={task.id}
                  className="flex items-center gap-4 p-4 rounded-2xl bg-white/50 dark:bg-secondary/30 hover:bg-white/80 dark:hover:bg-secondary/50 transition-all"
                >
                  <div
            ...
            <CardContent className="space-y-3">
              {aiSuggestions.map((suggestion, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="flex items-center justify-between p-4 rounded-2xl bg-gradient-to-r from-[#4f46e5]/5 to-[#06b6d4]/5 dark:from-[#7c3aed]/10 dark:to-[#06b6d4]/10 border border-[#4f46e5]/10 dark:border-[#7c3aed]/20 hover:border-[#4f46e5]/30 dark:hover:border-[#7c3aed]/40 transition-all"
                  >
                    ...
                    <Button variant="ghost" size="sm" className="rounded-xl text-[#4f46e5] dark:text-[#7c3aed]">
                      {suggestion.action}
                    </Button>
                  </div>
                );
        ...
        <div className="space-y-6">
                ...
                <div key={index} className="flex gap-3">
                  <div className="relative">
                    ...
                    {index < activities.length - 1 && (
                      <div className="absolute left-1/2 top-4 bottom-0 w-px bg-gray-200 dark:bg-gray-700 -translate-x-1/2" />
                    )}
                  </div>
          ...
          <Card className="backdrop-blur-xl bg-white/80 dark:bg-card/80 border-white/40 dark:border-border rounded-3xl">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <div className="flex justify-between mb-2">
                  <span className="text-sm text-gray-600 dark:text-gray-300">Goals</span>
              ...
              <div>
                <div className="flex justify-between mb-2">
                  <span className="text-sm text-gray-600 dark:text-gray-300">Automation</span>
