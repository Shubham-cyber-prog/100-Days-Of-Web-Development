...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const menuItems = [
    ...
    { path: '/competitor-analysis', icon: <Users className="h-5 w-5" />, label: 'Competitor Analysis' },
    { path: '/backlink-checker', icon: <LinkIcon className="h-5 w-5" />, label: 'Backlink Checker' },
    { path: '/site-speed', icon: <Zap className="h-5 w-5" />, label: 'Site Speed' },
    { path: '/ai-content-generator', icon: <Sparkles className="h-5 w-5" />, label: 'AI Content Generator' },
    { path: '/bulk-analyzer', icon: <Layers className="h-5 w-5" />, label: 'Bulk Analyzer' },
