...
export function Landing() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Compare your SEO performance against competitors and discover opportunities.'
    },
    {
      icon: <LinkIcon className="h-6 w-6" />,
      title: 'Backlink Checker',
      description: 'Track and analyze your backlink profile with domain authority metrics.'
    },
    {
      icon: <Zap className="h-6 w-6" />,
      title: 'Site Speed Monitor',
      description: 'Monitor page speed and Core Web Vitals for optimal performance.'
    },
    {
      icon: <Sparkles className="h-6 w-6" />,
      title: 'AI Content Generator',
      description: 'Generate SEO-optimized content with AI for blogs, products, and more.'
    },
    {
      icon: <Layers className="h-6 w-6" />,
      title: 'Bulk URL Analyzer',
      description: 'Analyze multiple pages at once for comprehensive site-wide insights.'
    },
    {
