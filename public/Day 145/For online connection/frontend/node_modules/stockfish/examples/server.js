...
createServer(function(req, res)
{
    ...
    function showDir(filename)
    {
        ...
        html = "<!doctype html><html lang='en'><head><style>html{background: #000}a{color: #ccc!important;}</style><meta charset=utf-8><title>" + escapeHTML(p.basename(baseURL)) + "</title></head><body>";
